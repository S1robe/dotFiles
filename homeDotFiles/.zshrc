...
# case, to know which specific one was loaded, run: echo
# $RANDOM_THEME See https://github.com/ohmyzsh/ohmyzsh/wiki/Themes
ZSH_THEME="default"

# Set list of themes to pick from when loading at random Setting
# this variable when ZSH_THEME=random will cause zsh to load a
# theme from this variable instead of looking in $ZSH/themes/ If
# set to an empty array, this variable will have no effect.
...
# completion. Case-sensitive completion must be off. _ and - will
# be interchangeable. HYPHEN_INSENSITIVE="true"
...
# automatically without asking zstyle ':omz:update' mode reminder
# # just remind me to update when it's time

# Uncomment the following line to change how often to auto-update
# (in days). zstyle ':omz:update' frequency 13

# Uncomment the following line if pasting URLs and other text is
# messed up. DISABLE_MAGIC_FUNCTIONS="true"
...
# COMPLETION_WAITING_DOTS="%F{yellow}waiting...%f" Caution: this
...
# $SSH_CONNECTION ]]; then export EDITOR='vim' else export
# EDITOR='mvim' fi
...
# `alias`.-
#
# Example aliases alias zshconfig="mate ~/.zshrc" alias
